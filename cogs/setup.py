...
class Setup(commands.Cog):
    ...
    async def setup_verification(self, interaction: discord.Interaction, channel: discord.TextChannel):
        embed = discord.Embed(
            title="🎟️  Verify to Continue",
            description="Click the button below to verify and unlock the rest of the server.",
            color=PRIMARY,
        )
        embed.set_footer(text="Yoran Studios  •  Verification")
    ...
    async def setup_tickets(self, interaction: discord.Interaction, channel: discord.TextChannel, category: discord.CategoryChannel = None):
        ...
        embed = discord.Embed(
            title="🎫  Need Help?",
            description="Click the button below to open a private support ticket with our staff.",
            color=PRIMARY,
        )
        embed.set_footer(text="Yoran Studios  •  Support")
